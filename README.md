...
256 talks, 134 concepts, 276 speakers, almost a million words. Headline finding: of
134 concepts synthesized across those talks, zero came back settled practice (79
consolidating, 51 contested, 4 frontier). Browse the
...
pipeline, and then verified: 5,463 quotes across both events checked character for
