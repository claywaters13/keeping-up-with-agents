#!/usr/bin/env python3
"""Add (or update) one episode in podcast/feed.xml — idempotent.
...
What it does:
  ...
  4. Creates podcast/feed.xml with the show's <channel> boilerplate if it
...
FEED_URL = f"{SITE_BASE}/podcast/feed.xml"
