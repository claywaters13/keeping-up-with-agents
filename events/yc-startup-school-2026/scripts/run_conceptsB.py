...
Phase 1 (data/concepts/canonical.json, written by scripts/build_concepts_phase1.py)
already aliased a chunk of the raw strings; those assignments are authoritative and
free. This pass only handles the remainder, batched and run in parallel, resumable
per batch.
...
def build_prompt(vocab, batch):
    lines = [
        ...
        "of 14 Y Combinator Startup School 2026 talks and firesides.",
        "",
