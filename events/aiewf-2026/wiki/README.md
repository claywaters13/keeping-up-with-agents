...
A linked, graph-style wiki built from 256 talks at the AI Engineer World's Fair
...
sponsor slots. This corpus covers the 256 that had been published to the
...
- **256 talks** (254 individual talks plus 2 full-day livestream compilations)
- **1,021,270 deduplicated words**, **102.4 hours** of source material.
  Raw totals across all 256 entries are 1,098,714 words and
  110.2 hours. The difference is roughly 77,444 words of
...
- **5,135 verified quotes**, every one checked verbatim against the raw YouTube
...
| Consolidating | 79 | Converging practice, some open edges |
| Contested | 51 | Active, unresolved disagreement across talks |
...
**Speaker attribution:** 33 talks have multiple speakers. Where the
...
wiki/
  README.md            this file
  talks/<slug>.md       256 talk pages: summary, key points, quotes, positions, concepts
  ...
  speakers/<slug>.md    276 speaker pages: role, company, bio, talks, sessions,
                        concepts, quotes
```
...
5,135 quotes passed and are rendered across the 256 talk pages:
4,350 individually speaker-attributed, and 785
...
- `data/index.json`, the corpus index (256 entries)
